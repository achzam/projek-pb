...
?>
 <div class="col-md-8 offset-md-2" style="margin:0px;width:1200px;">
                        ...
                        <br>
                        <div><span style="float: right"><a href="Form Barang.php" target="isi"><button class="btn btn-primary" style="background-color:rgb(237,173,204);" class="btn btn-primary">Form Barang</button></a></span></div>
                        <br><br>
 <fieldset>
 <form method="post" id="forminput" enctype="multipart/form-data" action="dopenerimaan.php">
 ...
 <table class="table table-striped table-bordered table-list">
                        ...
                        <tbody>
                        <tr>
                            <td><select class="form-control" name="barang[0]">
                            <option disabled selected="selected">Barang</option>
                            <?php include 'koneksi.php';
                            $sql = mysqli_query($koneksi,"SELECT * FROM barang ORDER BY KODE_BAR ASC");
                            while ($row = mysqli_fetch_array($sql)){
                                echo "<option value=".$row['0'].">".$row['2']." </option>";
                            }
                            ?>
                            </select></td>
                            <td><input class="form-control" type="number" name="jumlah[0]"/></td>
                            <td align='center'>
                            <button type="button" style="background-color:rgb(237,173,204);" class="del">Hapus</button>
                            </td>
                        </tr>
                        </tbody>
                        <tr id="last">
                            <td colspan="4" align="right"><button style="background-color:rgb(237,173,204);" class="btn btn-primary" type="button" id="addRow">Add</button></td>
                        </tr>
                    </table>
                        <div class="btn">
