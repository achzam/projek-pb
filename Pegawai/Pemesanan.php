...
?>
                        ...
                        <h1 class="text-center" style="color:rgb(129,124,124);margin:10px;">Pemesanan</h1>
<div><span>&nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp;</span><span style="float:center"><a href="formpemesanan.php" target="isi"><button class="btn btn-primary" style="background-color:rgb(237,173,204);" class="btn btn-primary">Tambah Pemesanan</button></a></span></div>
 <br>
                        ...
                        while ($data = mysqli_fetch_array($hasil_data)){?>
                           <tr>
                            ...
                            <td><?php
                              $sts = $data['STATUS_PESAN'];
                              if($sts=='0'){
                                echo "<a href=detpeng.php?id=".$data[0]." class='btn btn-info btn-xs'>Detail</a>
                                <a href=deleteform.php?id=".$data[0]." style='background-color:rgb(255,0,0);' class='btn btn-info btn-xs'>Batal</a>";
                              }
                             else{
                                echo " <a href=detpeng.php?id=".$data[0]." class='btn btn-info btn-xs'>Detail</a> ";
                                }
