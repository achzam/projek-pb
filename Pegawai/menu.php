...
<div><a href="pendataanbarang.php" target="isi"><button class="btn btn-primary" type="button" style="background-color:rgb(255, 200, 230);color:rgb(16,15,15);height:40px;width:120px;">Pendataan</button></a></div><br>
