...
<html lang="en">
  ...
  <body>
  <h1 class="text-center" style="color:rgb(129,124,124);margin:0px;">Laporan Penerimaan</h1><br>
    ...
    <div class="panel-body" align="center">
                <table class="table table-striped table-bordered table-list" id="datatable" align="center">
                  <thead>
                    <tr>
                        <th style="background-color:rgb(255, 200, 230);">ID Penerimaan</th>
                  ...
                  @$bln=$_POST['bln'];
                  @$thn=$_POST['thn'];
                  $hasil = mysqli_query($koneksi,"select hp.id_trima, br.nama_bar, hp.jumlah_his, pn.tgl_trima, pn.status_trima from history_penerimaan hp join penerimaan pn on hp.id_trima=pn.id_trima join barang br on br.kode_bar=hp.kode_bar where month(tgl_trima)='$bln' and year(tgl_trima)='$thn' order by pn.tgl_trima");
      ...
      buttons: [
          {
              ...
              orientation: 'potrait',
              pageSize: 'LEGAL',
              title: 'Laporan Penerimaan Bulan <?= $bln ?> <?= $thn ?>'
          },
      ]
    });
